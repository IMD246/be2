						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="tg-authordetail">
								<figure class="tg-authorimg">
									<img style="width: 200px; height: 250px" src="<?php echo e(url('images/books')); ?>/<?php echo e($bookdetail->image); ?>" alt="image description">
								</figure>
								<div class="tg-authorcontentdetail">
									<div class="tg-sectionhead">
										<h2><span>Sold: <?php echo e($temp::find($bookdetail->idAuthor)->publishedBooks); ?> Books</span>Author: <?php echo e($temp::find($bookdetail->idAuthor)->nameAuthor); ?></h2>
                                        <p></p>

									</div>
                                    <br>
                                        <h3> Name: <?php echo e($bookdetail->nameBook); ?></h3>
                                    ...
                                    <div class="price">
                                      <p style="font-size: 20px; font-style: normal;">Price:
                                        <span style="margin-left: 300px; color: red;" class="new_price">
                                          <sup> <?php echo e($bookdetail->salePrice); ?>.000VND</sup>
                                        </span>
                                       </p>
                               ...
                               <form method="POST" action="<?php echo e(route('template.store')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <P>
                                       <input  id="idBook" value="<?php echo e($bookdetail->idBook); ?>" type="hidden" name="idBook" hidden/>
                                    </p>
									...
									<div class="tg-booksfromauthor" style="margin-top: 50px;">
										...
										<div class="row">
                                        <?php $__currentLoopData = $arrbook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

											<div class="col-xs-6 col-sm-6 col-md-4 col-lg-3">
												<div class="tg-postbook">
													<figure class="tg-featureimg">
														<div class="tg-bookimg">
															<div class="tg-frontcover"><img src="<?php echo e(url('images/books')); ?>/<?php echo e($item->image); ?>" alt="image description"></div>
															<div class="tg-backcover"><img src="<?php echo e(url('images/books')); ?>/<?php echo e($item->image); ?>" alt="image description"></div>
														</div>
													...
													<div class="tg-postbookcontent">
														<ul class="tg-bookscategories">
															<li><a href="../public/category_book.blade.php?idCategory=<?php echo e($item->idCategory); ?>"><?php echo e($temp1::find($item->idCategory)->nameCategory); ?></a></li>
														</ul>
														<div class="tg-themetagbox"><span class="tg-themetag">sale</span></div>
														<div class="tg-booktitle">
															<h3><a href="./book_detail.blade.php?idBook=<?php echo e($item->idBook); ?>"><?php echo e($item->nameBook); ?></a></h3>
														</div>
														<span class="tg-bookwriter">By: <a href="./authordetail.blade.php?id=<?php echo e($item->idAuthor); ?>"><?php echo e($temp::find($item->idAuthor)->nameAuthor); ?></a></span>
                                                      <?php for($x = 5; $x > 0; $x--): ?>
                                                    <?php
                                                             if($item->rate > 0.5){
                                                            echo '<i class="fa fa-star"></i>';
                                                         ...
                                                         $item->rate--;
                                                      ?>
                                                        <?php endfor; ?>														<span class="tg-bookprice">
															<ins><?php echo e($item->price); ?>.000VND</ins>
															<del><?php echo e($item->salePrice); ?>.000VND</del>
														</span>
                                  ...
                                  <?php $__currentLoopData = $review->where("idBook","=",$bookdetail->idBook); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <h3><?php echo e($key->comment); ?></h3>
                                    <p>
...
<?php /**PATH C:\wamp64\www\be2\library\resources\views/template/book_detail.blade.php ENDPATH**/ ?>