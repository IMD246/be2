...
<head>
   ...
   <header id="tg-header" class="tg-header tg-haslayout">
        <?php echo $__env->make('template.404error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <div class="tg-postbook">
                                        <figure class="tg-featureimg">
                                            <div class="tg-bookimg">
                                                <a href="./book_detail.blade.php?idBook=<?php echo e($book->idBook); ?>">
                                                    <div class="tg-frontcover"><img
                                                            src="<?php echo e(url('images/books')); ?>/<?php echo e($book->image); ?>"
                                        ...
                                        <div class="tg-postbookcontent">
                                            ...
                                            <ul class="tg-bookscategories">
                                                <li><a
                                                        href="../public/category_book.blade.php?idCategory=<?php echo e($book->idCategory); ?>"><?php echo e($temp1::find($book->idCategory)->nameCategory); ?></a>
                                                </li>
                                            </ul>
                                            <div class="tg-themetagbox"><span clas s="tg-themetag">sale</span></div>
                                            <div class="tg-booktitle">
                                                <h3><a
                                                        href="./book_detail.blade.php?idBook=<?php echo e($book->idBook); ?>"><?php echo e($book->nameBook); ?></a>
                                                </h3>
                                            </div>
                                            <span class="tg-bookwriter">By: <a
                                                    href="./authordetail.blade.php?id=<?php echo e($book->idAuthor); ?>"><?php echo e($temp::find($book->idAuthor)->nameAuthor); ?></a></span>
                                                    <?php for($x = 5; $x > 0; $x--): ?>
                                                    <?php
                                                             if($book->rate > 0.5){
                                             ...
                                             <span class="tg-bookprice">
                                                <ins><?php echo e($book->price); ?>.000VND</ins>
                                                <del><?php echo e($book->salePrice); ?>.000VND</del>
                                            </span>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row">
                                <div class="tg-newreleasebooks">
                                    <?php $__currentLoopData = $threenewstbook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xs-4 col-sm-4 col-md-6 col-lg-4">
                                            <div class="tg-postbook">
                                                ...
                                                <div class="tg-postbookcontent">
                                                    <ul class="tg-bookscategories">
                                                        <li><a
                                                                href="javascript:void(0);"><?php echo e($temp1::find($book->idCategory)->nameCategory); ?></a>
                                                        </li>
                    ...
                    <?php for($iw = 0; $iw <= 1; $iw++): ?>
                        ...
                        <div class="item">
                            <div class="tg-postbook">
                                <figure class="tg-featureimg">
                                    <div class="tg-bookimg">
                                        <div class="tg-frontcover"><img src="<?php echo e(url('images/books')); ?>/<?php echo e($data[$iw]->image); ?>"
                                                alt="image description"></div>
                                    </div>
                                    <div class="tg-hovercontent">
                                        <div class="tg-description">
                                            <p><?php echo e($data[$iw]->Description); ?></p>
                                        </div>
                                        <strong class="tg-bookcategory"><?php echo e($temp1->where('id', '=',$data[$iw]->idCategory)->first()->nameCategory); ?></strong>
                                        <strong class="tg-bookprice">Price: <?php echo e($data[$iw]->salePrice); ?>.000VND</strong>
                                        <?php for($x = 5; $x > 0; $x--): ?>
                                                    <?php
                                                             if($data[$iw]->rate > 0.5){
                                                            echo '<i class="fa fa-star"></i>';
                                ...
                                <div class="tg-postbookcontent">
                                    <div class="tg-booktitle">
                                        <h3><a href="./book_detail.blade.php?idBook=<?php echo e($data[$iw]->idBook); ?>"><?php echo e($data[$iw]->nameBook); ?></a></h3>
                                    </div>
                                    <span class="tg-bookwriter">By: <a href="./authordetail.blade.php?id=<?php echo e($data[$iw]  ->idAuthor); ?>"><?php echo e($temp->where('id', '=', $data[$iw]->idAuthor)->first()->nameAuthor); ?></a></span>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-lg-push-2">
                            <div id="tg-testimonialsslider" class="tg-testimonialsslider tg-testimonials owl-carousel">
                                ...
                                <div class="item tg-testimonial">
                                    <figure><img src="<?php echo e(url('images/books')); ?>/angrypikachu.jpg" alt="image description"></figure>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div id="tg-postslider" class="tg-postslider tg-blogpost owl-carousel">
                        ...
                        <?php $__currentLoopData = $featureArrayBook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <article class="item tg-post">
                                <figure><a href="javascript:void(0);"><img src="<?php echo e(url('images/books')); ?>/<?php echo e($item->image); ?>"
                                ...
                                <div class="tg-postcontent">
                                    ...
                                    <div class="tg-posttitle">
                                        <h3><a href="./book_detail.blade.php?idBook=<?php echo e($item->idBook); ?>"><?php echo e($item->nameBook); ?></a></h3>
                                    </div>
                                    <span class="tg-bookwriter">By: <a
                                            href="./authordetail.blade.php?id=<?php echo e($item->idAuthor); ?>"><?php echo e($temp->where('id', '=', $item->idAuthor)->first()->nameAuthor); ?></a></span>
                                                    <?php for($x = 5; $x > 0; $x--): ?>
                                                    <?php
                                                             if($item->rate > 0.5){
                                                            echo '<i class="fa fa-star"></i>';
                        ...
                        <div class="tg-threecolumns">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="tg-footercol tg-widget tg-widgettopsellingauthors">
                                    ...
                                    <div class="tg-widgetcontent">
                                        <ul>
                                            <?php $__currentLoopData = $top3Author; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                                                <li>
                                                    <figure><a href="./authordetail.blade.php?id=<?php echo e($key->id); ?>">
                                                    <img
                                                                src="images/author/<?php echo e($key->image); ?>"
                                                                alt="image description"></a></figure>
                                                    <div class="tg-authornamebooks">
                                                        <h4><a href="./authordetail.blade.php?id=<?php echo e($key->id); ?>"><?php echo e($key->nameAuthor); ?></a></h4>
                                                        <p><?php echo e($key->PublishedBooks); ?> Published Books</p>
                                                    </div>
                                                </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
...
<?php /**PATH C:\wamp64\www\be2\library\resources\views/template/index.blade.php ENDPATH**/ ?>